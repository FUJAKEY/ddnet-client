	...
	CEntity(pWorld, CGameWorld::ENTTYPE_CHARACTER, vec2(0, 0), CCharacterCore::PhysicalSize())
{
	...
	m_StrongWeakId = 0;
	// m_LastAutoHookTick = 0; // Removed auto-hook feature
	// m_TicksSinceLastFreezePrediction = 0; // Removed auto-hook feature
...
// Auto-hook save feature was here (PredictFreezeCollision, FindHookTargetTile, TryAutoHookSave)
