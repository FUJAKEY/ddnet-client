 ...
 */
MACRO_CONFIG_INT(ClAutoAvoidFreeze, cl_auto_avoid_freeze, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Automatically hook to avoid freeze tiles (predict 5 ticks ahead)")
